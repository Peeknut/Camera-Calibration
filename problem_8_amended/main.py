...
from refine_intrinsics_extrinsics import refine_intrinsics_extrinsics_param
...
def calibrate():
    ...
    [intrinsics_param, extrinsics_param] = refine_intrinsics_extrinsics_param(intrinsics_param,
                                            extrinsics_param, real_points, pic_points)
    #畸变矫正
