...
# iteration：迭代次数：一个bactch训练一次=1个iteration
parser.add_argument('--num_iterations', default=10000,
                    help='number of training iterations')
parser.add_argument('--batch-size', default=16, help='batch-size to use')
# patchsize:表示图像块大小
parser.add_argument('--patch-size', default=37, help='patch size from left image')
# 视差范围
parser.add_argument('--disparity-range', default=101, help='disparity range')
